...
<head>
    ...
    .header-container {
        ...
        align-items: center;
        background: linear-gradient(90deg, #007bff, #6f42c1); /* Blue to Purple */
        padding: 5px 15px;
        border-radius: 10px;
...
<body>
    ...
    <div class="profile-preview">
        <img id="profilePreview" src="your-image-url.jpg" alt="Profile Preview">
    </div>
</div> <form id="registrationForm" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
